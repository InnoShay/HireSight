              ...
              <div className="nav-dropdown">
                ...
                >
                  ...
                  <div className="dropdown-text">
                    <span className="dropdown-title">LinkedIn</span>
                    <span className="dropdown-subtitle">Connect with us</span>
                  </div>
                </a>
                <a
                ...
                >
                  ...
                  <div className="dropdown-text">
                    <span className="dropdown-title">GitHub</span>
                    <span className="dropdown-subtitle">Star our repo</span>
                  </div>
                </a>
              </div>
            </div>
