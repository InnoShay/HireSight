...
import { ArrowLeftIcon, CalendarIcon, UserGroupIcon, BriefcaseIcon } from "@heroicons/react/24/outline";
            ...
            <div className="bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-30 shadow-sm transition-colors duration-200">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <h1 className="text-xl font-bold text-gray-800 dark:text-white">Role History</h1>
                    </div>
                    <ThemeToggle />
                </div>
            </div>
